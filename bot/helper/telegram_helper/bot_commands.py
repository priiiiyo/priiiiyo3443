...
class _BotCommands:
    def __init__(self):
        ...
        self.AddLeechLogCommand = f'addleech{CMD_INDEX}'
        self.RmLeechLogCommand = f'rmleech{CMD_INDEX}'
        self.AddLeechLogAltCommand = f'addleechalt{CMD_INDEX}'
        self.RmLeechLogAltCommand = f'rmleechalt{CMD_INDEX}'
